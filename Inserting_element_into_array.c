...
void* insert(void* arr, unsigned size, unsigned idx, void* source, unsigned sourceSize)   //We are going byte by byte in this function to make this general.
{
	...
	memcpy((char*)newArr + idx, source, sourceSize);    //Simply because char* is a pointer to 1 byte.
